...
from recover_book_3_successor_anchors import (
    build_pairs,
...
PATHS = {
    ...
    "report": ROOT
    / "content/migration/reports/reading-segment-book-2-successor-anchor-recovery-summary.md",
    "private": ROOT
    / ".vereda-private/source-review/pr-0034-book-2-successor-anchors/source-recovery-evidence.local.json",
}


def global_exact_current_candidates(
    ...
    for page_index, page in enumerate(pages):
        ...
        for match in find_title_matches(
            ...
            if match["method"] != "normalized-exact":
                continue
...
def top_pair_is_ambiguous(
    ...
    return (
        ...
        < 0.05
        and (
            first["current"]["page_number"]
            != second["current"]["page_number"]
            or first["successor"]["page_number"]
            != second["successor"]["page_number"]
        )
    )
...
def main() -> None:
    ...
    if (
        ...
        raise RuntimeError(
            "Book 2 successor-anchor baseline differs."
        )
    ...
    for analysis_item in sorted(
        ...
        if (
            ...
            raise RuntimeError(
                ...
                "canonical recovery identity differs."
            )
        ...
        if not pairs:
            current_candidates = (
                global_exact_current_candidates(
                    pages,
                    current_title,
                    original_page,
                    policy["matching_rules"][
        ...
        if not current_candidates:
            ...
            confidence = "low"
            unresolved_reason = (
                "successor-anchor-pair-ambiguous"
            )
        ...
        evidence = {
            ...
            "search_scope":
                search_scope,
            "current_page_distance_from_original":
                (
                    current[
                        "distance_from_original"
                    ]
    ...
    public = {
        ...
        "totals": {
            ...
            "global_fallback_resolution_count":
                sum(
                    item["recovery_status"]
                    == "resolved"
                    and item["evidence"][
    ...
    private = {
        "schema_version": 1,
        "status":
            "private-book-2-successor-anchor-recovery-evidence",
        "warning":
    ...
    report_lines = [
        ...
        "## Recovery outcomes",
        "",
        "| Segment | Search | Current page | Successor | Successor page | Outcome | Decision | Confidence |",
        "| --- | --- | ---: | --- | ---: | --- | --- | --- |",
    ]
