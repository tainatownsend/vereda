    ...
    <main className="northstar-page pb-28">
      <div className="northstar-container pt-7 sm:pt-10">
        ...
        <header className="mt-5 max-w-2xl">
          <p className="text-sm font-semibold uppercase tracking-[0.12em] text-sage-700 dark:text-sage-300">Jornada pela obra</p>
        ...
        <EditorialCard className="mt-7 p-5 sm:p-6">
          <div className="flex items-end justify-between gap-4">
            <div>
              <p className="text-sm font-semibold uppercase tracking-[0.1em] text-sage-700 dark:text-sage-300">Seu caminho nesta obra</p>
        ...
        <section className="mt-8" aria-labelledby="guided-sessions-title">
          <p className="text-sm font-semibold uppercase tracking-[0.12em] text-sage-700 dark:text-sage-300">Percurso</p>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-3">
                          <div>
                            <p className="text-sm font-semibold uppercase tracking-[0.08em] text-muted dark:text-night-muted">
                        ...
                        <p className="mt-2 flex items-center gap-1.5 text-sm font-medium text-muted dark:text-night-muted">
                          <Clock3 size={14} aria-hidden="true" /> cerca de {session.minutes} min
                        </p>
                        <div className="mt-3 flex flex-wrap gap-2">
                          {session.concepts.slice(0, 3).map((concept) => (
                            <span key={concept} className="rounded-full bg-surface-soft px-2.5 py-1 text-sm text-muted dark:bg-night dark:text-night-muted">{concept}</span>
                          ))}
                        </div>
                      </div>
                    </div>
