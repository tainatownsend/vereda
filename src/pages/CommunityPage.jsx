...
import { BookPlus, MoreHorizontal, Plus, Users } from 'lucide-react'
      ...
      <div className="northstar-container pt-9">
        ...
        {tab === 'grupos' ? (
          <>
            ...
            <EditorialCard as="button" type="button" onClick={() => navigate('/sugerir-obra')} className="mt-6 flex w-full items-center gap-3 p-4 text-left">
              ...
              <span className="flex-1">
                <span className="block text-sm font-semibold text-ink dark:text-night-ink">Sugestões da comunidade</span>
                <span className="mt-0.5 block text-xs text-muted dark:text-night-muted">Peça uma nova obra ou vote nas sugestões existentes.</span>
              </span>
            </EditorialCard>
