...
Future classifications are `MATCH`, `STATUS_ALREADY_APPLIED`, `STATUS_UNEXPECTED`, `IDENTITY_MISSING`, `BOUNDARY_DRIFT`, `CONTENT_DRIFT`, `METADATA_DRIFT`, `SOURCE_HASH_DRIFT`, `DUPLICATE_TARGET`, `UNAUTHORIZED_TARGET`, and `INSUFFICIENT_BASELINE`. Boundary and content drift always block application.
